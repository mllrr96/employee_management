        ...
        body: GridView(
          ...
          children: [
            ...
            AdminActionWidget(
              ...
              onTap: () => context.router.push(const ManageScheduleRoute()),
            ),
            AdminActionWidget(
              title: 'Manage Employees',
              icon: EmployeeIcons.employee_group,
              color: const Color(0xff479696),
              onTap: () => context.router.push(const ManageEmployeesRoute()),
            ),
            AdminActionWidget(
              title: 'Manage Admins',
              icon: EmployeeIcons.admin,
              color: const Color(0xffFF5648),
              onTap: () => context.router.push(const ManageAdminsRoute()),
            ),
          ],
        ),
      );
